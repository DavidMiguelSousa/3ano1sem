...
{
    public class OperationTypeServiceIntegrationWithIsolationTest : IClassFixture<TestDatabaseFixture>
    {
        ...
        public OperationTypeServiceIntegrationWithIsolationTest(TestDatabaseFixture fixture)
        {
        ...
        public async Task GetByIdAsync_ReturnsOperationType_WhenIdExists()
        {
            ...
            Assert.Equal(OperationType.PhasesDuration.Preparation.Value, OperationType.PhasesDuration.Preparation.Value);
            Assert.Equal(OperationType.PhasesDuration.Surgery.Value, OperationType.PhasesDuration.Surgery.Value);
            Assert.Equal(OperationType.PhasesDuration.Cleaning.Value, OperationType.PhasesDuration.Cleaning.Value);
        }
